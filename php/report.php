<?php
   ...
   if ($conn -> connect_error) {
    ...
    $regquery = " select * from course where reg = '$reg' and ccode = '$ccode' and  exam = '$exam' and slot = '$slot'";
    $sql2 = mysqli_query($conn, $regquery);

    $regcount = mysqli_num_rows($sql2);
    
    if ($regcount < 1) {
        echo "You have not entered marks for the following subject and exam";
    }
    else {
